...
engine::gui::FramedSprite::LayoutConfig::UVs buildUVsForProgressBarTexture()
{
...
engine::gui::FramedSprite::LayoutConfig buildLayoutConfigForProgressBarTexture()
{
...
, normalTexture_{TextureLibrary::instance().get("progressbar_background")}
{
    ...
    auto textPtr = engine::gui::Label::create("", style.text);
    text_ = textPtr.get();
