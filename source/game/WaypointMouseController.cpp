...
engine::gui::EventStatus WaypointMouseController::onButtonPressed(const sf::Vector2f& mouse_position, const sf::Mouse::Button& button, bool)
{
...
engine::gui::EventStatus WaypointMouseController::onButtonReleased(const sf::Vector2f&, const sf::Mouse::Button&)
{
    return engine::gui::EventStatus::NotConsumed;
}

engine::gui::EventStatus WaypointMouseController::onMouseMoved(const sf::Vector2f&)
{
    return engine::gui::EventStatus::NotConsumed;
}
