...
public:
    static const std::map<std::string, std::string>& getAssets()
    {
        ...
        static const std::map<std::string, std::string> assets
        {
            ...
            {"flat_button",                  concat(texturePath, "classic/flat_button.png")},
            {"flat_button_hover",            concat(texturePath, "classic/flat_button_hover.png")},
            {"flat_button_pressed",          concat(texturePath, "classic/flat_button_pressed.png")},
